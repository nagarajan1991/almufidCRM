...
@Component ({
  selector: 'app-visit-list-admin',
  templateUrl: './visit-list-admin.component.html',
  styleUrls : ['./visit-list-admin.component.css']
})


export class VisitListAdminComponent implements OnInit, OnDestroy {
  // visits = [
